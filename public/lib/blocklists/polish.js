...
export const polishJokeNames = [
  ...
  // ── Apellidos-broma: nombre polaco + vulgaridad concatenada
  ['jankurwicki',          '"Jan Kurwicki" → "jan, kurwa..."'],
  ['adamjebalski',         '"Adam Jebalski" → "adam jebał" follaba'],
  ['mariapizdowska',       '"Maria Pizdowska" → maria, pizda...'],
  ['piotrchujowski',       '"Piotr Chujowski" → de mierda (chujowy)'],
  ['tomaszkutasiak',       '"Tomasz Kutasiak" → contiene kutas (polla)'],
  ['annaspierdalska',      '"Anna Spierdalska" → spierdalaj vete'],
  ['michalpierdolski',     '"Michal Pierdolski" → pierdol się'],
  ['kasiacipinska',        '"Kasia Cipinska" → cipa (coño)'],
  ['jacekdupinski',        '"Jacek Dupinski" → dupa (culo)'],
  ['pawelchujak',          '"Pawel Chujak" → chuj (polla)'],
  ['ewasrakowska',         '"Ewa Srakowska" → sraka (cagona)'],
  ['robertkurwinski',      '"Robert Kurwinski" → robert, kurwi się'],
  ['marekjebakowski',      '"Marek Jebakowski" → marek jebaka...'],
  ['olajebanska',          '"Ola Jebanska" → puta'],
  ['wojciechpierdziak',    '"Wojciech Pierdziak" → pierdziel (gilipollas)'],
  ['krzysztofgownianski',  '"Krzysztof Gownianski" → de mierda (gówniany)'],
  ['stanislawhujak',       '"Stanislaw Hujak" → huj (polla)'],
  ['monikadupczynska',     '"Monika Dupczynska" → dupczy folla vulg'],
  ['barbarakurwiak',       '"Barbara Kurwiak" → barbara, kurwa...'],
  ['tadeuszskurwiel',      '"Tadeusz Skurwiel" → cabrón'],
  ['agniezkapierdzielska', '"Agnieszka Pierdzielska" → pierdziel cretino'],
  ['januszzjebany',        '"Janusz Zjebany" → puto jodido'],
  ['halinapizdaszka',      '"Halina Pizdaszka" → halina, pizda...'],
  ['romansrakowiak',       '"Roman Srakowiak" → sraka cagada'],
  ['filipchujkowski',      '"Filip Chujkowski" → filip, chuj...'],
  ['witoldpojebany',       '"Witold Pojebany" → puto loco'],
  ['zenonkutasinski',      '"Zenon Kutasinski" → kutas polla'],
  ['darekfiucinski',       '"Darek Fiucinski" → fiut pene'],
];
