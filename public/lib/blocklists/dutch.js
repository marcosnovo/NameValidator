...
export const dutchJokeNames = [
  ...
  // ── Apellidos-broma: nombre + vulgaridad concatenada
  ['jankankerhond',        '"Jan Kankerhond" → perro-de-cáncer'],
  ['piettyfuslijder',      '"Piet Tyfuslijder" → tifoso como insulto'],
  ['kareltering',          '"Karel Tering" → tuberculoso'],
  ['willemklootzak',       '"Willem Klootzak" → cabrón'],
  ['hendrikkutkop',        '"Hendrik Kutkop" → cabeza-de-coño'],
  ['joophoerenzoon',       '"Joop Hoerenzoon" → hijo de puta'],
  ['bartlulhannes',        '"Bart Lulhannes" → gilipollas NL'],
  ['cornelisreetneuker',   '"Cornelis Reetneuker" → follaculos'],
  ['dirkpleurislijer',     '"Dirk Pleurislijer" → "que te dé pleuresía"'],
  ['frankschijtkop',       '"Frank Schijtkop" → cabeza-de-mierda'],
  ['gerardstrontvent',     '"Gerard Strontvent" → tipo-de-mierda'],
  ['huubkankerlijder',     '"Huub Kankerlijder" → canceroso'],
  ['kobusmongoolkop',      '"Kobus Mongoolkop" → insulto capacitista'],
  ['lodewijkkontlikker',   '"Lodewijk Kontlikker" → lameculos'],
  ['marniksletje',         '"Marnik Sletje" → putilla'],
  ['nielsteringhond',      '"Niels Teringhond" → perro-tuberculoso'],
  ['paulkleretering',      '"Paul Kleretering" → maldición compuesta'],
  ['robklootviool',        '"Rob Klootviool" → gilipollas'],
  ['sjoerdkankerhoer',     '"Sjoerd Kankerhoer" → puta-cancerosa'],
  ['tijsmafkees',          '"Tijs Mafkees" → chiflado peyorativo'],
  ['vincentschijterd',     '"Vincent Schijterd" → cagón'],
  ['wouterhoerenkind',     '"Wouter Hoerenkind" → hijo de puta'],
  ['ysbrandopgerot',       '"Ysbrand Opgerot" → "lárgate a la mierda"'],
  ['zegerdebielkop',       '"Zeger Debielkop" → cabeza-débil-mental'],
  ['adriaankrijgdetering', '"Adriaan, krijg de tering"'],
  ['bramopgeneukt',        '"Bram Opgeneukt" → follado/jodido'],
];
