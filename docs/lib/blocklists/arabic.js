...
export const arabicJokeNames = [
  ...
  // ── Apellidos-broma: nombre árabe transliterado + vulgaridad concatenada
  ['khalidibnelhmir',       '"Khalid ibn el-hmir" → hijo del burro'],
  ['ahmedyakulkos',         '"Ahmed ya kul kos" → come coño'],
  ['mahmoudkosokhtak',      '"Mahmoud kos okhtak" → el coño de tu hermana'],
  ['samirsharmoota',        '"Samir Sharmoota" → sharmuta (puta)'],
  ['walidibnelqahba',       '"Walid ibn el qahba" → hijo de puta'],
  ['hassankosimmak',        '"Hassan kos immak" → el coño de tu madre'],
  ['rashidzobikbir',        '"Rashid zobik bir" → tu polla vulgar'],
  ['tarekayrifibouk',       '"Tarek ayri fi bouk" → mi polla en tu boca'],
  ['naderibnelkalb',        '"Nader ibn el kalb" → hijo de perro'],
  ['fadiibnelharam',        '"Fadi ibn el haram" → hijo del haram'],
  ['omarmanyooka',          '"Omar Manyooka" → jodido vulgar'],
  ['kareemkahbawi',         '"Kareem Kahbawi" → qahbawi putero'],
  ['saidteezak',            '"Said Teezak" → tu culo'],
  ['bilalibnsharmoota',     '"Bilal ibn sharmoota" → hijo de puta'],
  ['yusufkossomak',         '"Yusuf kos omak" → coño de tu madre'],
  ['nizarallayl3anak',      '"Nizar allay l3anak" → que Dios te maldiga'],
  ['adelmalounabu',         '"Adel mal3oun abu" → maldito'],
  ['mounirhayawan',         '"Mounir Hayawan" → animal insulto'],
  ['ramyahbaloglu',         '"Ramy Ahbaloglu" → ahbal imbécil'],
  ['ashrafzbeleh',          '"Ashraf Zbeleh" → zbeleh basura insulto'],
  ['imadwessikha',          '"Imad Wessikha" → wessikh sucio vulgar'],
  ['fawzikhanazir',         '"Fawzi Khanazir" → khanzir cerdo insulto'],
  ['salimibnelkahba',       '"Salim ibn el kahba" → hijo de puta'],
  ['rafiqkosukhtak',        '"Rafiq kos ukhtak" → coño de tu hermana'],
  ['tahabintkahba',         '"Taha bint kahba" → hija de puta'],
  ['jamalzibik',            '"Jamal Zibik" → tu polla'],
  ['idrisibnharameh',       '"Idris ibn harameh" → hijo del haram'],
  ['amirkahbatak',          '"Amir Kahbatak" → tu puta vulgar'],
  ['hosseinkossok',         '"Hossein kos sok" → vulgar'],
];
