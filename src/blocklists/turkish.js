...
export const turkishJokeNames = [
  ...
  // ── Apellidos-broma: nombre turco + vulgaridad concatenada
  ['mehmetsikerim',         '"Mehmet, sikerim" → te follo'],
  ['aliyarrakov',           '"Ali Yarrakov" → yarrak (polla)'],
  ['hasansiktiroglu',       '"Hasan Siktiroglu" → siktir vete a la mierda'],
  ['mustafaamcikoglu',      '"Mustafa Amcikoglu" → amcık (coño)'],
  ['ibrahimgotveren',       '"Ibrahim Gotveren" → slur homófobo'],
  ['emirsiktirgit',         '"Emir Siktirgit" → siktir git vete'],
  ['serkanyarragim',        '"Serkan Yarragim" → mi polla'],
  ['hakanananisiken',       '"Hakan Ananisiken" → me follo a tu madre'],
  ['canansurtukoglu',       '"Canan Surtukoglu" → sürtük (puta)'],
  ['burakkaltakov',         '"Burak Kaltakov" → kaltak (puta)'],
  ['kemalpicherif',         '"Kemal Picherif" → piç herif bastardo'],
  ['osmankahpeoglu',        '"Osman Kahpeoglu" → kahpe (puta)'],
  ['fatihtasakoglu',        '"Fatih Tasakoglu" → taşak (huevos)'],
  ['murataminakoy',         '"Murat Aminakoy" → amına koyim te jodo'],
  ['recepibneoglu',         '"Recep Ibneoglu" → ibne slur homófobo'],
  ['volkanpustkurusu',      '"Volkan Pust kurusu" → insulto homófobo'],
  ['oguzkopoglu',           '"Oguz Kopoglu" → hijo de perro'],
  ['baranyavsakoglu',       '"Baran Yavsakoglu" → yavşak sinvergüenza'],
  ['enesgotdelik',          '"Enes Gotdelik" → göt delik agujero del culo'],
  ['tunaserefsizoglu',      '"Tuna Serefsizoglu" → şerefsiz sin honor'],
  ['halilboklusurat',       '"Halil Boklusurat" → cara de mierda'],
  ['ercansoysuzov',         '"Ercan Soysuzov" → soysuz sin linaje'],
  ['yasinmanyakoglu',       '"Yasin Manyakoglu" → manyak loco'],
  ['cengizpicleri',         '"Cengiz Picleri" → piçler bastardos'],
  ['onurgerizekali',        '"Onur Gerizekali" → geri zekalı retrasado'],
  ['umutsikkomehmet',       '"Umut Sikko Mehmet" → sikko vulgar'],
  ['arifgotcuoglu',         '"Arif Gotcuoglu" → götçü culero'],
];
